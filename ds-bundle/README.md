...
This design system is imported as **reference screens** — full-page designs that establish the visual language. Use them as the canonical reference when building new screens for رِواق العِلم.

| Screen | Group | Canvas | File |
|---|---|---|---|
| الرئيسية (Home) | الشاشات | 390×844 | `components/Mobile/Home/Home.html` |
| صفحة القسم (Section page, reusable) | الشاشات | 390×844 | `components/Mobile/SectionPage/SectionPage.html` |
| مشغّل الصوت (Audio player) | الشاشات | 390×844 | `components/Mobile/AudioPlayer/AudioPlayer.html` |
| رفع محاضرة (Admin upload) | لوحة الإدارة | 1440×900 | `components/Admin/UploadLecture/UploadLecture.html` |

Each screen has a sibling `.prompt.md` documenting its layout, states, and exact values.
